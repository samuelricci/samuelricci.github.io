...
var State = function(old) {
    ...
    /*
     * public : the board configuration in thsi state
     */
    this.board = [];
    ...
    /*
     * public functions that checks if the state is a terminal state or not
    ...
    this.isTerminal = function() {
        ...
        for(var i = 0; i <= 6; i = i + 3) {
            if(B[i] !== "E" && B[i] === B[i + 1] && B[i + 1] == B[i + 2]) {
                this.result = B[i] + "-won"; //udate the state result
                return true;
            }
        }
